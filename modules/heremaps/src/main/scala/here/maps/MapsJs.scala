...
/**
 * The Here Maps API for Scala.js <p> This is a Un-Official Scala.js facade for
 * the HERE Maps API. It allows you to use the HERE Maps API from Scala.js code.
 * </p> <p> The facade tries to be as close as possible to the original
 * JavaScript API (https://developer.here.com/documentation/maps/
 */
@js.native
...
object MapsJs extends js.Object {
   ...
   * @param baseLayer
   *   {!mapsjs.map.layer.Layer} baseLayer The layer to be used as the base
   *   layer.
   * @param opt_options
   *   {!mapsjs.Map.Options=} opt_options Additional map options (for example a
   *   map view)
   */
  @js.native
  class Map(element: Element, baseLayer: js.Object, opt_options: js.Object)
      extends js.Object {
    def setCenter(center: MapPoint,
        opt_animate: Boolean = false): Unit = js.native
...
class MapPoint(val lng: UndefOr[Double], val lat: UndefOr[Double])
    extends js.Object {
  @JSName("apply")
...
class PlatformOptions(
  ...
  @JSName("apply")
  def apply(
      apikey: js.UndefOr[String], headers: js.UndefOr[js.Object]
  ): PlatformOptions =
